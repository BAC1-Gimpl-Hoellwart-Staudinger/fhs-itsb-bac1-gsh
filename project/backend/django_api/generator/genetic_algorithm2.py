...
class GeneticAlgorithm2:
    ...
    def generate_population(start_date, end_date, metadata_body, size):
        ...
        for _ in range(size):
            ...
            population.append(Individual(schedule, GeneticAlgorithm2.fitness(schedule, start_date, end_date, metadata_body)))
        return population
    ...
    def combine_mutate(mating_pool, start_date, end_date, metadata_body):
        ...
        for i in range(len(parent1)):
            ...
            new_population.append(Individual(new_schedule, GeneticAlgorithm2.fitness(new_schedule, start_date, end_date, metadata_body)))
